...
function Navbar () {
  ...
  return (
    <>
    <div className={` max-w-screen-2x1 container mix-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
        sticky
  ...
  <div className="">
    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 curson-pointer">Login</a>
  </div>
</div>
</div>
    </div>
